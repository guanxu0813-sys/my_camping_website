...
| EXP-2026-08-12-DATA-01 | Adding three reproducible cross-category findings to the weight-price report will make the dataset easier for relevant editors to assess and cite. | `/guides/camping-gear-weight-price-report-2026.html` | None; this is a single data asset and outreach quality will be reviewed directly | Relevant editorial replies and acquired links | Organic entrances, data accuracy and correction requests | 2026-08-12 | 2026-09-23 | Six relevant editorial contacts or one acquired editorial link | observing | Three tailored notes were sent on 2026-08-13; retain the currency and sample limitations and do not follow up unless the later outreach review permits it. |

## Maintenance log

| ID | Date | Reason code | URLs or files | Change | Verification | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| MAINT-2026-08-12-MONGAR-01 | 2026-08-12 | DATA_CORRECTION | Mongar Base 2 and Base 3 official records | Replaced storefront variant weights with official total weights and stored minimum weights separately | Compared both current Naturehike technical-spec blocks and recorded the review in `growth-day26-mongar-base-source-review.md` | The future guide must label minimum and total weight; shipping/variant weights remain excluded. |
