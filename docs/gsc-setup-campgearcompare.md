...
- **收录提交策略**：见 [`gsc-indexing-api-setup.md`](./gsc-indexing-api-setup.md)。Google 使用 sitemap；Bing 等使用 IndexNow，不再向不支持普通内容的 Google Indexing API 提交装备页。
- 验证 GA4：见 [`custom-domain-setup.md`](./custom-domain-setup.md) §5
